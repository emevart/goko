...
const VISUALS: Record<OrbState, OrbVisual> = {
  connecting: { colorA: [0.48, 0.5, 0.55], colorB: [0.18, 0.22, 0.28], glow: [0.48, 0.5, 0.55], scale: 0.93, deformation: 0.014, voiceDeformation: 0, breath: 0.004, pulse: 0.15, speed: 0.12, opacity: 0.58 },
  muted: { colorA: [0.36, 0.42, 0.5], colorB: [0.12, 0.15, 0.2], glow: [0.36, 0.42, 0.5], scale: 0.94, deformation: 0.022, voiceDeformation: 0, breath: 0.007, pulse: 0.22, speed: 0.18, opacity: 0.7 },
  listening: { colorA: [0.42, 0.92, 0.72], colorB: [0.08, 0.38, 0.34], glow: [0.18, 0.78, 0.58], scale: 1, deformation: 0.052, voiceDeformation: 0.14, breath: 0.022, pulse: 0.72, speed: 0.8, opacity: 0.92 },
  thinking: { colorA: [0.74, 0.62, 1], colorB: [0.28, 0.18, 0.55], glow: [0.55, 0.36, 0.92], scale: 0.99, deformation: 0.062, voiceDeformation: 0, breath: 0.031, pulse: 0.48, speed: 0.5, opacity: 0.88 },
  tool: { colorA: [1, 0.84, 0.42], colorB: [0.62, 0.25, 0.06], glow: [0.95, 0.56, 0.16], scale: 1.01, deformation: 0.07, voiceDeformation: 0, breath: 0.024, pulse: 0.58, speed: 0.64, opacity: 0.94 },
  speaking: { colorA: [1, 0.82, 0.55], colorB: [0.7, 0.18, 0.13], glow: [1, 0.48, 0.22], scale: 1.03, deformation: 0.06, voiceDeformation: 0.18, breath: 0.032, pulse: 0.95, speed: 1.08, opacity: 0.98 },
  error: { colorA: [1, 0.58, 0.52], colorB: [0.42, 0.1, 0.12], glow: [0.85, 0.24, 0.2], scale: 0.97, deformation: 0.028, voiceDeformation: 0, breath: 0.01, pulse: 0.28, speed: 0.2, opacity: 0.82 },
};
