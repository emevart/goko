...
export function createTools(deps: ToolDeps) {
  ...
  return {
    ...
    get_assessment: llm.tool({
      description: 'Служебно получить оценку позиции: кто впереди и на сколько, слабые группы со всеми камнями и свободами, кандидаты с оценками. Вызов невидим человеку: не объявляй сверку; кандидаты и оценки называй только по прямой просьбе подсказать ход.',
